...
fn make_rust_ref_file() -> ReferenceFile {
    ReferenceFile {
        ...
        entries: vec![
            ReferenceEntry::basic("Result".to_string(), EntryKind::TypeAlias, "type Result<T>".to_string(), String::new(), String::new()),
            ReferenceEntry::basic("Context".to_string(), EntryKind::Trait, "trait Context".to_string(), String::new(), String::new()),
            ReferenceEntry::basic("anyhow!".to_string(), EntryKind::Macro, "anyhow!(msg)".to_string(), String::new(), String::new()),
            ReferenceEntry::basic("bail!".to_string(), EntryKind::Macro, "bail!(msg)".to_string(), String::new(), String::new()),
            ReferenceEntry::basic("context".to_string(), EntryKind::Method, ".context(msg)".to_string(), String::new(), String::new()),
            ReferenceEntry::basic("chain".to_string(), EntryKind::Method, ".chain()".to_string(), String::new(), String::new()),
        ],
